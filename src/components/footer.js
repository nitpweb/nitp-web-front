  ...
  return (
    <FooterStyle>
        ...
        <div className="foot-col-8">
          ...
          <div className="footsec">
            ...
            <div className="foot-col-3">
              ...
              <a
                href="https://web.nitp.ac.in/uploads22/Academic_Calendar_2022_23_UG_1st_Year_updated.pdf"
                target="_blank"
              >
      ...
      <div className="footdetail">
        <p>
          National Institute of Technology Patna-800005, Bihar, INDIA ©{new Date().getFullYear()}  NIT
          Patna
        </p>
      </div>
    </FooterStyle>
