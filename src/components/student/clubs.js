...
Expresso was formed back in 2019 with a vision to celebrate the infinite mind. Expresso came up as an amalgamation of both Literary and Arts Clubs of NIT Patna and brought them together, 'Infinite Ideas, One Place'.

We believe in bringing out one's true creative self and building the courage to stand among all. Guided and supported by our Dean Student Welfare, Dr. Prakash Chandra and also our Professor In charge, Dr. Khursheed Ahmad, and not to mention the sincere efforts of the founding members and the team we have grown up and are still rising.`,
  ...
  },
  {
    ...
    Title: "ISIE NITP SRA",
    description:
      "ISIE stands for IMPERIAL SOCIETY OF INNOVATIVE ENGINEERS. Keeping in view ,the declining technical knowledge among students of NIT patna and the need of renewal sources of energy as fuel, our 2015 batch seniors established this club in 2017. Improvement in technical knowledge of students and to create a hub for solar powered vehicles have been our prime focus. Innovation has been a key essence to our club. ISIE serves as a platform for new start-ups and for youngsters who really want to contribute to society. Collectively we work on different innovations that could enhance the performance of a solar powered vehicle at the same time keeping its price suitable for a country like India.",
    link: "/",
  },
  {
    url: "/sae.jpg",
    Title: "SAE INDIA NITP",
    description:
      "SAE ( Society of Automotive Engineers), found in 2014 and currently under the leadership of professor Dr.  Nimai Pada Mandal. Here we innovatively design & fabricate two major sector which comes under mechanical engineering automotive ( SUPRA) and aerodynamics (ADC). Our team NITP MOTORSPORTS under SUPRA SAEINDIA NITP designs and fabricates the most fascinating car by young generation- Formula 1 from scratch and compete among 125+ colleges in Buddha International Circuit . We dive deeper into the types of advanced materials used, their properties and processing methods and behold the future of racing! We have two other teams TEAM INVICTUS and TEAM VYOM  under ADC [Aero Design Challenge] Section of SAE INDIA NITP Collegiate Club which developes Robust methods upon designing, manufacturing and indeed flying.Flying is hypnotic and TEAM INVICTUS is a willing victim to that spell. Among 100 + Teams that have participated we INVICTUS have secured 12th position and a very few among them who made it to the ground in Regular Category . TEAM VYOM a MICRO Category UAV In which the aircraft will be hand launched and its a aircraft without having any landing gears. The team consisted of 7 students of our college. It was set to participate in the SAE ADC COMPETITION 2022 as every year the team from our college participates. Apart from all these we organize many events ,seminars and workshops for holistic development of our college students..",
    link: "/",
  },
]
