...
export const vision = () => {
 return (
  <>
   To provide globally competitive and high quality human resource by preparing
   students with broad-based / specialized technical education at UG, PG, and
   Ph.D. levels.
   <br />
   To increase research intensity and become a leading product based innovation
   centre by significantly contributing towards development of new technologies.
   <br />
 ...
 return (
  <div className="img-11">
   ...
   <div className="img img-12">
    <img
     src="https://drive.google.com/thumbnail?authuser=0&sz=w320&id=1sj6PJ0DyjOOMlZvfgerow2riwZonI9z0"
     alt="hodImage"
    />
    <br />
    <br />
