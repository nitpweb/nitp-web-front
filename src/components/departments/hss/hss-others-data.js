...
export const Activities = {
  content: (
    <>
      <ul>
        <li>
          One Day National Seminar on “Women Health: Mental and Physical” on
          15th September 2022.
        </li>
        <li>
        ...
        <li>
          AICTE Training and Learning (ATAL) Academy sponsored Five Days online
          FDP on Capacity Building, 14-18 December 2020.
        </li>
        <li>
          Webinar on “Aatmanirbhar Bharat: A Roadmap for Inclusive Growth” on
          2nd October 2020.
        </li>
        <li>
          Online Expert Lecture on “Understanding New National Education Policy”
        ...
        <li>
          Expert Lecture on “Sampling Methods in Statistics” on 28th January
          2015.
        </li>
        <li>
          Expert Lecture on “Communication Skills: An Important Employability
          Skill for Workplace Success” on 28th August, 2014.
        </li>
      </ul>
...
export const Outcomes_ = [
  {
    ...
    content: (
      <>
        <ul>
          <li>
            To involve entire range of knowledge pertinent to human relationship
            with society interaction and teaching towards problems solving of
            the nation.
          </li>
          <li>
            To develop into well rounded personalities and to propagate
            knowledge that is utilitarian and aesthetic in its makeup.
          </li>
          <li>
            To develop good technological skills with the ability to interact
            with different organs of an organization.
          </li>
          <li>
            To develop essential skills in critical thinking and writing along
            with the knowledge of literature,society, economic value, and
    ...
    content: (
      <>
        <ul>
          <li>
            <span>
              Producing Technocrats with all round knowledge and development
              skills.
            </span>
          </li>
          <li>
            <span>
              Developing professional ethics, communication skills and
              managerial knowledge among students to work in corporate world
  ...
  content: (
    <>
      ...
      <h2>
        ...
        where students access audio-visual materials. It adapts a perfect blend
        of Instructor-Led-Training and Computer-Based-Training. The assessment
        on speaking and listening programme along with reading and writing,
        listening and speaking skills to promote proficiency of language.
      </h2>
    </>
  ),
  // image: (
