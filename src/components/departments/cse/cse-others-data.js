    ...
    content: (
      <>
        ...
        <p>
          ...
          programming related to OS system call functions. This lab also deals
          with courses like Object- Oriented Programming (OOP), Web Technology,
          Database Management (DBMS), Artificial Intelligence (AI), and Software
          Engineering.
        </p>
      </>
    ),
    ...
    content: (
      <>
        ...
        <p>
          ...
          Simulation lab uses the IBM Rational Rose software and other software
          to design software modules. This lab also deals some courses like
    ...
    content: (
      <>
        ...
        <p>
          ...
          System Kit (5 no.).  */}
          The lab has well equipped system for research, which include the
          Network Training Kit. The lab deals with Cyber Security courses.
        </p>
      </>
    ),
    image: (
    ...
    content: (
      <>
        ...
        <p>
          ...
          Trainer Kit (10 no.).  */}
          Soft Computing lab use Statistica software for supervised learning
          analysis and data mining and also used the LAN Trainer kit for network
          topology. The lab is focusing on IOT related specific courses.
        </p>
      </>
    ),
    image: (
    ...
    content: (
      <>
        ...
        <p>
          ...
          The lab uses Statistica for supervised learning analysis and data
          mining work and Qualnet simulator for network simulation work.
        </p>
      </>
    ),
    // image: (
    ...
    content: (
      <>
        ...
        <p>
          ...
          software testing, mobile application development, cloud computing,
          network security, Big Data analysis and Industrial Automation. This
          also deals some courses like Data Structure and Algorithms, Operating
    ...
    content: (
      <>
        ...
        <p>
          ...
          (14.04 64-bit) OS. */}
          This deals with some courses like Data Structure and Algorithms,
          Operating System, Compiler Design, and Computer Graphics.
        </p>
      </>
    ),
    // image: (
...
export const Activities = [
  {
    ...
    content: (
      <ul>
        <li>
          <span>
            Workshop/Short Term Courses on "Concepts of Cryptographic
            Engineering" from 19<sup>th</sup>
            February 2018 to 23<sup>rd</sup> February 2018.
          </span>
        </li>
        <li>
          <span>
            Workshop/Short Term Courses on "Artificial Intelligence &amp;
            Machine Learning" from 18<sup>th</sup>
            May 2018 to 22<sup>nd</sup> May 2018.
          </span>
        </li>
        <li>
          <span>
            Workshop/Short Term Courses on "Deep Learning and applications" from
            27<sup>th</sup> May 2019 to 31<sup>st</sup> May 2019.
          </span>
        </li>
        <li>
          <span>
            Workshop/Short Term Courses on "Introduction to Programming: A
            Pedagogical Approach" from 17<sup>th</sup> June 2019 to 22
        ...
        <li>
          <span>
            Workshop/Short Term Courses on "Artificial Intelligence &amp;
            Machine Learning" from 12<sup>th</sup>
            February 2020 to 16<sup>th</sup> February 2020.
          </span>
        </li>
        <li>
          <span>
            Workshop/Short Term Courses on "Cyber Security Using Machine
            Learning/Big Data Analytics" from 17<sup>th</sup> February 2020 to
            21<sup>st</sup> February 2020.
          </span>
        </li>
        <li>
          <span>
            Workshop/Short Term Courses on "Understanding the concept of Node.JS
            and React.JS from 20<sup>th</sup>
            May 2020 to 26<sup>th</sup> May 2020.
          </span>
        </li>
        <li>
          <span>
            Workshop/Short Term Courses on "Deep learning and its Applications"
            from 17<sup>th</sup>
        ...
        <li>
          <span>
            Workshop/Short Term Courses on "Machine learning for Computer
            Vision" from 29<sup>th</sup>
        ...
        <li>
          <span>
            ...
            Application in Computer Vision" from 12<sup>th</sup> August 2020 to
            18<sup>th</sup>
            August 2020.
          </span>
        </li>
        ...
        <li>
          <span>
            Workshop/Short Term Courses on "Python Programming" from 7
            <sup>th</sup> September 2020 to 18<sup>th</sup> September 2020.
          </span>
        </li>
        <li>
          <span>
