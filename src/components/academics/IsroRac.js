...
export const MoU = () => {
 return (
   <p>MoU documents can be found here:<a href="https://drive.google.com/file/d/1VWtRgrYUm3FgDRphBtzrpitG0VnrpF4d/view" style={{color:'blue'}}><u>Link</u></a></p>
 )
}
export const Contact = () => {
 return (
  <div style={{paddingTop:'2rem'}}>
      <b>Regional Coordinator, ISRO-NIT Patna Regional Academic Centre for Space (RAC-S)<br/>
National Institute of Technology Patna<br/>Email: racs@nitp.ac.in<br/>Phone: +91 7752957828/9523592768 </b>
   </div>
 )
}
...
export const CallForProposal = () => {
 return (
    <div >
   <h2> 
Call for Project Proposal RAC-S ISRO NIT Patna</h2>
<br/>
<p>ISRO- NIT Patna Regional Academic Centre for Space (RAC-S) invites research project proposal from the permanent faculty members of NIT Patna and faculty members from other reputed institutes of eastern region (Bihar, Jharkhand, Odisha, Sikkim, West Bengal and A&N Islands) in the areas of relevance to the future technological and programmatic needs of the Indian Space Programme.
<br/><br/>
<strong>Nature of the Project:</strong><br/>
<ol>
   <li>Reputed institutes include all IITs/NITs/IIITs/CFTIs/CUs/other institutes (Bihar, Jharkhand, Odisha, Sikkim, West Bengal and A&N Islands) who’s NIRF rank is within 100.</li>
   <li> Institutes other than NIT Patna must have a PI/Co-PI from NIT Patna.</li>
    <li>Projects shall be of two types. (i) Short term projects for B.Tech. and M.Tech Students, of up to one year duration. (ii) Long term R & D projects (More than 1-year duration) preferably leading to Ph.D.</li>
    <li> Short Term Projects: 3rd Year or 4th year B.Tech. students or M.Tech students shall participate in the short term research projects of less than one year duration. The total project cost shall not exceed <b>Rupees One Lakh</b>.</li>
    <li> Long Term R & D Projects, preferably leading to Ph.D Programme (More than 1 year duration). NIT Patna and other associated Institutes shall identify R & D projects of relevance to space programme of one to three years’ duration. In such projects, the principal investigator of the project shall be from the associating institutes and the Co-PI can be from NIT Patna or vice versa.  The PI shall be responsible for the budget management of the project. There will be provision for JRF and SRF in these projects as per RESPOND norms.  Candidates, who have cleared NET/GATE or equivalent qualification from all over the country are eligible for RESPOND JRF /SRF and carry out their Ph.D. programme. If the student is already getting any stipend, then the total emoluments should not exceed the JRF/SRF eligibility. The total project cost shall not exceed <b>Rupees Twenty-Five Lakh</b> .</li>
...
<ol>
   ...
   <li>The selection will be based on the provisions of ISRO- NIT Patna Regional Academic Centre for Space (RAC-S).</li>
</ol>
<br/>
<strong>Necessary Details:</strong>
<ol>
   <li>The general terms and conditions will be as per RAC-S ISRO NIT Patna MOU.</li>
   <li>The selection will be based on the provisions of ISRO- NIT Patna Regional Academic Centre for Space (RAC-S).</li>
...
<br/>
<strong>Project Template:</strong><br/><br/>
