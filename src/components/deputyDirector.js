          ...
          <div className="faculty-details-row">
            ...
            <div className="fac-card" data-aos="">
              <p id="dir" style={{ textAlign: `justify` }}>
                Prof. S. K. Verma is the Deputy Director, NIT Patna. He holds
                B.Sc (Engg.), M.Sc (Engg.) and Ph.D (Engg.) from BIT, Sindri,
                Ranchi University, Ranchi. His Specialization is âHeat Power
                Engineeringâ. His area of research includes Solar Energy,
                Stirling Cycle Engine and Computational Fluid Dynamics. He has
                contributed in the development of the Institute by taking
                responsibility at key positions like Head of the Department
                (Mechanical Engineering), Dean (Student Welfare), Dean
                (Academic) and Chairman (ACoFAR). He has membership of
                Professional Societies like the Institution of Engineers
                (India), Indian Society of Mechanical Engineers, Indian Society
                for Technical Education, Solar Energy Society of India and
                American Society of Mechanical Engineers. He has published the
