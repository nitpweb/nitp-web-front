...
const studentexchange = " National Institute of Technology (NIT), Patna has recently signed a memorandum of understanding (MoU) with the Handong Global University, Pohang, South Korea for exchange of students, faculty and research. The first six-month exchange programme will be funded by UNICEF. The research areas in focus are urban planning, urban development, infrastructure development and electrical engineering, all of which relate most directly to Bihar’s immediate needs. South Korea is known the world over for its highly advanced monorail system which also has a low impact on traffic flow on roads under construction. Automated driverless trains are another feature of the monorail; an Indian student may want to study. Apart from the concrete advantages, exchange of students and faculty and exposure to the teaching practices in South Korea is likely to have enormous impact on engineering education as being imparted at NIT Patna in the coming days.";
...
const Studentpage = () =>{
    return (<div className="studentsection">
        ...
        <div className="smainrow">
            ...
            <div css={css`align-items:center;`} className="col-6">
                <div className="row">
                    <h1>Annual Tech-Fest of NIT Patna</h1></div>
        ...
        <div className="smainrow">
            ...
            <div css={css`align-items:center;`} className="col-6">
                <div className="row">
                    <h1>Student Exchange Program</h1></div>
                <div className="row" css={css`margin-right:3vw;`}>
                    <h3>
                    {studentexchange}
                    </h3>
