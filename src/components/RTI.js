      ...
      <table className="table-act" border="1" style={{ textAlign: "justify" }}>
        <tbody>
            ...
            <td>
              ...
              <ul>
                ...
                <li>
                  ...
                  computer or in any other device subject to relevant provisions
                  in this regard
                </li>
              </ul>
            </td>
          ...
          <tr>
            ...
            <td>
              To provide available information of the Institute as enshrined in
              RTI ACT to the Indian citizen on payment of prescribed fees.
            </td>
          </tr>
          <tr>
            <td>1.4</td>
          ...
          <tr>
            ...
            <td>
              Administrative Office Orders / Decisions and Guidelines as
              approved by Institutes' Governing Body i.e. Board of Governors
              (BOG)
            </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              with, or representation by the member so of the public in relation
              to the formulation of its policy or implementation thereof
            </td>
            <td>
              Interested persons may write to the Public Information Officer of
              the Institute
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              <p>
                {" "}
                Appellate Authority Registrar National Institute of Technology
                Patna Patna-800 005.
              </p>
              <p>
                All matters relating to NIT Patna including its various
                Departments including Research &amp; Development matters,
                Centres, Interdisciplinary Programmes and Sections.
                <br />
                All matters relating to NIT Patna including its various
                Departments (except Dean Research &amp;
                Development),Centres,Interdisciplinary Programmes and Sections.
              </p>
            </td>
          </tr>
        </tbody>
